...
{
Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "Rogith.J");

    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "212224040280");
        HAL_Delay(500);
}
void SystemClock_Config(void)
{
...
<img width="848" height="678" alt="Screenshot 2025-09-22 091052" src="https://github.com/user-attachments/assets/cc3364fc-5b7d-45ff-9a7e-c7b75f987fae" />

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 <img width="781" height="752" alt="Screenshot 2025-09-22 091039" src="https://github.com/user-attachments/assets/e0146522-c81a-4fc2-879b-360b0f749aa6" />
